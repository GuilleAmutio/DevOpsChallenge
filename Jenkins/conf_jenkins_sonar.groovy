...
Thread.start {
    ...
    // Obtener la Configuración Global del plugin de Sonarqube
    ...
    def sonar_inst = new SonarInstallation(
        ...
        sonar_server_url,
        sonar_auth_token,
        hudson.util.Secret serverAuthenticationToken,
        sonar_auth_token,
        sonar_mojo_version,
    ...
    def sonarRunner_inst = new SonarRunnerInstallation("SonarQube", "", [installSourceProperty])
